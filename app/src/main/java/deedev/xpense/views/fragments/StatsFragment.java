...
import static deedev.xpense.utils.Constants.SELECTED_STATS_TYPE;
...
import deedev.xpense.databinding.FragmentStatsBinding;
        ...
        viewModel.categoriesTransactions.observe(getViewLifecycleOwner(), new Observer<RealmResults<Transaction>>() {
            ...
            public void onChanged(RealmResults<Transaction> transactions) {
                ...
                if(transactions.size() > 0) {
                    ...
                    binding.noTransactionImage2.setVisibility(View.GONE);
                    binding.noTransactionText2.setVisibility(View.GONE);
                    ...
                    binding.noTransactionImage2.setVisibility(View.VISIBLE);
                    binding.anyChart.setVisibility(View.GONE);
                    binding.noTransactionText2.setVisibility(View.VISIBLE);
                }
